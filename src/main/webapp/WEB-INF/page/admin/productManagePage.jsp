...
<div class="frm_div text_info">
    <div class="frm_group">
        ...
        <select class="selectpicker" id="select_product_category" name="categoryId" data-size="8">
    ...
    <div class="frm_group">
        ...
        <input class="frm_input frm_num"  id="input_product_sale_price" name="lPrice" type="text" placeholder="最低价" maxlength="10">
        <span id="text_cut">—</span>
        <input class="frm_input frm_num"  id="input_product_price" name="hPrice" type="text" placeholder="最高价" maxlength="10">
